...
**/
module uefi.protocols.graphicsoutput;
import uefi.base;
import uefi.base_type;

public:
extern (C):
enum EFI_GUID EFI_GRAPHICS_OUTPUT_PROTOCOL_GUID = EFI_GUID(0x9042a9de, 0x23dc,
...
**/
alias EFI_GRAPHICS_OUTPUT_PROTOCOL_QUERY_MODE = EFI_STATUS function(
    EFI_GRAPHICS_OUTPUT_PROTOCOL* This, UINT32 ModeNumber, UINTN* SizeOfInfo,
    EFI_GRAPHICS_OUTPUT_MODE_INFORMATION** Info) @nogc nothrow;
/**
...
**/
alias EFI_GRAPHICS_OUTPUT_PROTOCOL_SET_MODE = EFI_STATUS function(
    EFI_GRAPHICS_OUTPUT_PROTOCOL* This, UINT32 ModeNumber) @nogc nothrow;
...
**/
alias EFI_GRAPHICS_OUTPUT_PROTOCOL_BLT = EFI_STATUS function(
    EFI_GRAPHICS_OUTPUT_PROTOCOL* This,
    EFI_GRAPHICS_OUTPUT_BLT_PIXEL* BltBuffer,
    EFI_GRAPHICS_OUTPUT_BLT_OPERATION BltOperation, UINTN SourceX, UINTN SourceY,
    UINTN DestinationX, UINTN DestinationY, UINTN Width, UINTN Height, UINTN Delta) @nogc nothrow;
